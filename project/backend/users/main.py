...
# TODO originはこんな感じで指定するでもいいかも
# 参考（https://stackoverflow.com/questions/71802652/react-not-showing-post-response-from-fastapi-backend-application/71805329#71805329）
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
